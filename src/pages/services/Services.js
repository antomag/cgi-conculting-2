...
const Services = () => {
  return (
    <>
      <img src="/img/operarios.png" alt="operarios en planta" className="imgOperators"/>
      <Container>
        ...
        <section style={{marginTop:'2%'}}>
          ...
          <img src="/img/rack.png" alt="operario controlando rack electrico" className="imgRack"/>
        </section>
        <br/>
        <section style={{marginTop:'2%'}}>
        ...
        <section style={{marginTop:'2%'}}>
          ...
          <img src='/img/cascos.png' alt="cascos de operarios" className="imgHelmets"/>
        </section>
      </Container>
      <Footer/>
    </>
