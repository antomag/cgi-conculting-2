  ...
  return (
    <div className="containerFooter">
      <div className="cgi">
        ...
        <img src='/img/Logo-removebg-previewEdited.png' alt="Logo CGI." className="logo" />
      ...
      <div className="contactUs">
        ...
        <div className="iconsRedes">
          <a href="https://www.facebook.com/cgiconsultinginc" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon
              icon={faFacebookF}
              className="nav-icon"
            ></FontAwesomeIcon>
          ...
          <a href="https://www.instagram.com/cgiconsulting/" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon
              icon={faInstagram}
              className="nav-icon"
            ></FontAwesomeIcon>
